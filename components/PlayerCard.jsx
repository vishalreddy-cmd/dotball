  ...
  return (
    <div
      ...
      style={{
        ...
        border: selected ? `1.5px solid ${tc?.bg || '#6366f1'}66` : '1px solid #383838',
        background: selected ? `${tc?.bg || '#6366f1'}18` : '#222222',
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
          <span style={{ fontSize: 12, fontWeight: 600, color: '#e8e6e0' }}>{player.n}</span>
          {player.c !== 'IN' && <span style={{ fontSize: 9, color: '#5e5a56', marginLeft: 3 }}>[{player.c}]</span>}
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 5, marginTop: 2 }}>
          ...
          {ownership > 0 && (
            <span style={{ fontSize: 8, color: ownership >= 50 ? '#f5a623' : '#5e5a56' }}>
              {ownership}% picked
            </span>
          )}
        </div>
      ...
      <div style={{
        ...
        border: `1.5px solid ${selected ? `${tc?.bg || '#6366f1'}88` : '#383838'}`,
        background: selected ? tc?.bg || '#6366f1' : '#383838',
        color: selected ? '#fff' : '#5e5a56',
