...
export default function NotifPrompt({ uid }) {
  ...
  return (
    <div style={{
      ...
      background: '#222222', border: '1px solid #6366f144', borderRadius: 16,
      padding: '14px 16px', boxShadow: '0 8px 32px #00000066',
    }}>
      <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10, marginBottom: 12 }}>
        <div style={{ fontSize: 24, flexShrink: 0 }}>🔔</div>
        <div>
          <div style={{ fontSize: 13, fontWeight: 700, color: '#e8e6e0', marginBottom: 3 }}>
            Stay in the game
          </div>
      ...
      <div style={{ display: 'flex', gap: 8 }}>
        ...
        <button onClick={dismiss}
          style={{ flex: 1, padding: '10px 0', borderRadius: 10, border: '1px solid #383838', background: 'transparent', color: '#9a9590', fontSize: 12, cursor: 'pointer' }}>
          Not now
        </button>
      </div>
    </div>
